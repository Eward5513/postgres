...
FROM trace_range_query(116.3974, 39.9042, 10.5, 116.3974, 39.9042, 10.5, -1000.0, 9999.0, 7);

-- 测试稍微扩展的边界
SELECT COUNT(*) as expanded_boundary_points
FROM trace_range_query(116.3973, 39.9041, 10.4, 116.3975, 39.9043, 10.6, -1000.0, 9999.0, 7);
...
FROM trace_range_query(116.39, 39.90, 5.0, 116.41, 39.92, 16.0, -1000.0, 9999.0, 7);

-- 查询特定数据类型
SELECT COUNT(*) as specific_data_type
FROM trace_range_query(116.39, 39.90, 5.0, 116.41, 39.92, 16.0, -1000.0, 9999.0, 1);
...
FROM trace_range_query(200.0, 200.0, 200.0, 201.0, 201.0, 201.0, -1000.0, 9999.0, 7);

-- 查询不存在的数据类型
SELECT COUNT(*) as empty_data_type
FROM trace_range_query(116.39, 39.90, 5.0, 116.41, 39.92, 16.0, -1000.0, 9999.0, 4);
...
FROM trace_range_query(116.398, 39.905, 11.0, 116.397, 39.904, 10.0, -1000.0, 9999.0, 7);
